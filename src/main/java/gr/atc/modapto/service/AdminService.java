...
public class AdminService implements IAdminService {
    ...
    private static final List<String> SUPER_ADMIN_EXCLUDED_ROLES = List.of("default-roles-modapto-system", "uma_authorization", "offline_access");
    private static final List<String> ADMIN_EXCLUDED_ROLES = List.of("default-roles-modapto-system", "uma_authorization", "offline_access", "SUPER_ADMIN");
