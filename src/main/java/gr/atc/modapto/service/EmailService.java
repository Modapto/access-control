...
public class EmailService implements IEmailService {
  ...
  private static final String SUBJECT_ACTIVATE_STRING = "Welcome to MODAPTO System! Activate your account";
  private static final String SUBJECT_RESET_STRING = "Reset your password in MODAPTO System";
  ...
  private static final String RESET_PASSWORD_EMAIL_TEMPLATE = """
            ...
            <body style="font-family: Arial, sans-serif; margin: 0; padding: 0; background-color: #f4f4f4; color: #333; line-height: 1.5;">
              <div style="max-width: 600px; margin: 20px auto; background: #ffffff; padding: 20px; border-radius: 8px; box-shadow: 0 2px 5px rgba(0, 0, 0, 0.1);">
                ...
                <p style="font-size: 16px;">You requested to reset password in MODAPTO System. Click the button below to set up a new password.</p>
